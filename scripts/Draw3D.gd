#Code from: https://www.youtube.com/watch?v=JnrhURF1jgM
extends Node
...
func point(pos: Vector3, radius = 0.05, color = Color.WHITE_SMOKE, persist_s = 0):
	var mesh_instance := MeshInstance3D.new()
...
func square(pos: Vector3, size: Vector2, color = Color.WHITE_SMOKE, persist_s = 0):
	var mesh_instance := MeshInstance3D.new()
